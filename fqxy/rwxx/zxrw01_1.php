...
echo "<font color=black>去村长家看看吧，村长最近可愁坏了！</font>"."<br>";

} elseif ($rid==2||$rid==3) {
echo "<font color=black>村长</font>"."<font color=black>：【</font>"."<font color=black>$name</font>"."<font color=black>】你来了，是这样的，村外沙滩上出现了很多具有攻击性的螃蟹，你去帮我除掉一些！（温馨提示，使用新手礼包，戴上装备，用门派技能去杀螃蟹！）
</font>"."<br>";
...
echo "<font color=black>去新手村找村长有任务交给你</font>"."<br>";
...
echo "<font color=black>需要除掉8只潮洞蟹，快去吧！</font>"."<br>";
...
} elseif ($rid==18||$rid==19||$rid==20) {
echo "<font color=black>带上这船票去码头找船夫，让他带你到外面的世界去历练历练，还有这信，你交给长安城的店小二，他看到信会帮你的！</font>"."<br>";

} elseif ($rid==21) {

echo "<font color=black>到外面的世界去历练历练，还有这信，你交给长安城的店小二，他看到信会帮你的！！</font>"."<br>";
} elseif ($rid==22) {
...
echo "<font color=black>【和长安药铺掌柜杨中顺说话】</font>"."<br>";
echo "<font color=black>$name</font>"."<font color=black>：好了！这下药引应该够了吧！</font>"."<br>";
//快速任务
$ydx=1;//移动坐标x
$ydy=22;//移动坐标y
$ydfy=100;//传送费用	
