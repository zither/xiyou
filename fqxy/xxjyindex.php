...
include("./url/url.php");
$jy_enable_https = config_item('jy_enable_https') ?: false;
$xyurl = sprintf("http%s://%s/xxjy/index.php", $jy_enable_https ? 's' : '', $xxjyurl);
...
<div class="g-ft f-cb">
    <div class="f-fr"><a href="<?php echo $xyurl; ?>" class="to-top">返回官网</a><br/></div>
</div>
</body>
</html>
