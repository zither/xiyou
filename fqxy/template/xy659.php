...
if($zsspd==1){
    ...
    $zzid = array_key_first($zzwpid_arr);
    ...
    if($zzwpid>=1){//
        ...
        if($npcc==1){//〖金豆〗
            ...
            if ($pd==2) {
                ...
                $strsql = "update $q2 set zzwpmz='$wpdz1[0]',zzwpid='$wpdz3[0]',zzwpsl='$wpdz4[0]',zztime='$nowtime',sftime='$tiemxx',shtime='$tiemxx1' where id=$zzid";//物品id号必改值
