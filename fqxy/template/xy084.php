...
$strsql = "delete from $q2 where wjid=$wjid and  zbid=$npcc ";//物品id号必改值
$result = mysql_query($strsql);
 $q2="zb";
$sql1 = "insert into $q2 (wjid,zbid,zbxj,zbk1,zbxq1,zbk2,zbxq2,zbk3,zbxq3,zbk4,zbxq4,zbk5,zbxq5,zbpd)  values('$wjid','$npcc','$ssxvjj','$sszbkk1','$sszbxqq1','$sszbkk2','$sszbxqq2','$sszbkk3','$sszbxqq3','$sszbkk4','$sszbxqq4','$sszbkk5','$sszbxqq5','0')";
