...
//清空家具
$q2="jj";
$strsql= "delete from $q2 where wjid=$wjid1";
...
if($jd==""){  
$q2="wp";
$sql = "insert into $q2 (wjid,wpid,wpsl,wpfl)  values('$wjid','127','$jdd','4')";
...
$q2="wp";
$strsql = "update $q2 set wpsl=$jdd where wjid=$wjid and wpid=127";//物品id号必改值
$result = mysql_query($strsql);
include("./ini/sc_ini.php");
