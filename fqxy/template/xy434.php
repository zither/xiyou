...
$q2="sw";
$strsql = "update $q2 set swzz=$fbbb3 where wjid=$wjid and swid=8";
$result = @mysql_query($strsql);
...
$q2="wp";
$strsql = "update $q2 set wpsl=$fbbb4 where wjid=$wjid and wpid=127";
$result = @mysql_query($strsql);
...
$q2="xl";
$strsql = "update $q2 set xldj=$rwxldj where wjid=$wjid and xlid=2";
$result = @mysql_query($strsql);
//修炼等级提升
//更新缓存数据
$inina="ztt.ini";
