...
$q2="tx";
    //Fixed: 条件中的 wpid 字段为空，修改为 txid
$strsql = "update $q2 set txxs=2 where wjid=$wjid and txid=$npcc";//物品id号必改值
...
$q2="tx";
//Fixed: wpid 修改为 txid
$strsql = "update $q2 set txxs=1 where wjid=$wjid and txid=$npcc";//物品id号必改值
$result = mysql_query($strsql);
