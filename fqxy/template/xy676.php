...
echo "<br>";
echo "<br>";
echo "<font color=black>拉人SDK码包含以下物品</font></a>"."<br>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=679;
$npc[]=777;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>【10元充值卡】x1</font></a><br>";
...
$clj[]=679;
$npc[]=821;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖云梯石〗x20</font></a><br>";
...
$clj[]=679;
$npc[]=941;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖护身符〗x20</font></a><br>";
...
$clj[]=679;
$npc[]=944;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖紫星币〗x10</font></a><br>";
...
echo "<br>";
echo "<font color=red>温馨提示：此SDK码奖励需要条件！进群按照填写的游戏id进行发放没有填则不能奖励此SDK码并且完成游戏注册（需要真实有效玩家，禁止小号，违规者不排除封号的可能）</font></a>"."<br>";
