...
$czcs=$czcs+1;	
$q2="fb";
$strsql = "update $q2 set wc=1,cs=$czcs where wjid=$wjid and fbid=$fbcz";//物品id号必改值
...
//获取最大值
$q2="yxrw";
$sql = "insert into $q2 (wjid,rwid,rwbl,rwmz,ysg,yisg,rwfl)  values('$wjid','$fbcz','0','$fbmz','0','0','3')";
